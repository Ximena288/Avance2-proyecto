...
class FacturacionApp(QMainWindow):
    ...
    def setup_ui(self):
        ...
        self.btnMenu = QPushButton("Ir al Menú", self.centralwidget)
        self.btnMenu.setStyleSheet("background-color: rgb(255, 255, 102);")
        self.btnMenu.clicked.connect(self.regresar_menu)
        main_layout.addWidget(self.btnMenu)
